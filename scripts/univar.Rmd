...
yao %>% 
  countplotprint(has_contact_traveler, flip = T)
...
## 12.1 Have you had difficulty in accessing medical centers due to inavailability or raised prices of transport?
...
## 12.2 Since March 1st, have you felt that...

```{r fig.width=8, fig.height=3.8}
yao %>% 
  plot_upset(cat_col = mcat_diffic_find_care, 
             intersect_cutoff = 1) 
```
...
```{r}
yao %>% 
  countplotprint(has_confin_disrupted_life, flip = T, na_relevel = T)
```
