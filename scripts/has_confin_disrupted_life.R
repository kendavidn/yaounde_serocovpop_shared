...
t_all <- 
  ...
  count_and_prop_impact("has_confin_disrupted_life", "all_respondents")

t_sex <- 
  yao %>% 
  count_and_prop_impact("has_confin_disrupted_life", "cat_sex")
...
t_age <- 
  ...
  count_and_prop_impact("has_confin_disrupted_life", "cat_age")
...
t_educ <- 
  ...
  count_and_prop_impact("has_confin_disrupted_life", "cat_educ")
...
t_occup <-
  ...
  count_and_prop_impact("has_confin_disrupted_life", "mcat_occup")
...
t_respect_measures <- 
  ...
  count_and_prop_impact("has_confin_disrupted_life", "is_respecting_distancing")


t_pos <- 
  yao %>% 
  count_and_prop_impact("has_confin_disrupted_life", "cat_pos")
...
t_combined_wide <-
  ...
  pivot_wider(id_cols = c(var, filler), names_from = has_confin_disrupted_life, values_from = c(n, pct, pct_scale, pct_n, too_small, hjust)) %>%
...
has_confin_disrupted_life_plot <- 
  ...
  labs(x = "",y = "",
       title = '<br>**Disruption of daily activities** <br> <span style = "font-size:9pt; color:#595959;">*"Apart from work, have you been unable to carry out other daily activities (such as visiting family, making meals, taking care of the children) due to the confinement?"* </span>',
       caption = ""
  )
